...
class PCSession(object):
    ...
    def __init__(self,userid,userpass,customer_name,api_base,api_port):
        self.api_id = userid
    ...
    def authenticate_client(self):
        ...
        success = False
        prefix = "https://"  + self.api_base_url + ":" + self.api_port
        endpoint = prefix + "/api/v1/authenticate"
        body = {"username":self.api_id,"password":self.api_pass}
        max_tries = 5
